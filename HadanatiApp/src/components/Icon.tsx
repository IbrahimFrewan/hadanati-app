...
type IconName =
  ...
  | 'image' | 'meal' | 'sleep' | 'smile' | 'play' | 'grid' | 'list' | 'chart' | 'users'
  | 'wallet' | 'gift';
...
export function Icon({ name, size = 22, color = 'currentColor', fill = 'none', strokeWidth = 1.8 }: Props) {
  ...
  switch (name) {
    ...
    case 'sliders': return <Svg {...props}><Path d="M4 7h10M18 7h2M4 12h2M10 12h10M4 17h12M20 17h0" /><Circle cx="16" cy="7" r="2" /><Circle cx="8" cy="12" r="2" /><Circle cx="18" cy="17" r="2" /></Svg>;
    ...
    case 'crosshair': return <Svg {...props}><Circle cx="12" cy="12" r="7" /><Path d="M12 2v3M12 19v3M2 12h3M19 12h3" /><Circle cx="12" cy="12" r="2.2" /></Svg>;
    case 'refresh': return <Svg {...props}><Path d="M20 11a8 8 0 1 0-.6 4M20 5v6h-6" /></Svg>;
    case 'mapAlt': return <Svg {...props}><Path d="m9 4 6 2 6-2v16l-6 2-6-2-6 2V6l6-2Z" /><Path d="M9 4v16M15 6v16" /></Svg>;
    ...
    case 'paperclip': return <Svg {...props}><Path d="M20 11.5 12 19a5 5 0 0 1-7-7l8-8a3.4 3.4 0 0 1 5 5l-8 8a1.8 1.8 0 0 1-2.6-2.6L14 8" /></Svg>;
    ...
    case 'mail': return <Svg {...props}><Rect x="3" y="5.5" width="18" height="13" rx="2" /><Path d="m4 7 8 6 8-6" /></Svg>;
